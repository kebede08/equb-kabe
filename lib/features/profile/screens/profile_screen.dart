                ...
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: const Text('AK', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, color: AppColors.primary)),
                    ),
                    const SizedBox(height: 12),
                    const Text('Abebe Kebede', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                    const Text('+251 911 234 567', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  ],
                ),
              ),
            ),
